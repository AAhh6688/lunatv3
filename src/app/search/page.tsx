...
const FILTER_KEYWORDS = [
  ...
  '吃瓜', '黑料', '实锤', '不雅视频', 'XX门', '视频流出', '完整版', '反转', '爆料', '新作', '成人版', '苹果', '手机','电影解说', '灵蛇','捉奸','解说',
  ...
  '強姦', '強迫', '迷姦', '誘姦', '輪姦', '暴力', '血腥', '虐待', '凌辱', '禁錮', '監禁', '反抗', '慘叫', '倫理', '亂倫', '父女', '母子', '姐弟', '兄妹', '公公', '媳婦', '叔叔', '侄女', '爺爺', '孫女', '禁斷', '野戰', '野外', '車震', '酒店', '賓館', '洗手間', '公廁','伦理片', '三级片', '色情片', '情色', '成人片', '禁片', '禁忌', '禁欲', '艳情', '艳史', '艳舞', '裸体', '裸露', '裸戏', '床戏', '激吻', '亲热', '亲密', '缠绵', '缠身', '肉欲', '欲火', '欲念', '欲望', '情欲', '性感', '性骚扰', '性侵', '性虐', '性奴役', '虐杀片', '暴力片', '血腥片', '恐怖片', '惊悚', '惊悚片', '鬼片', '鬼魂', '厉鬼', '幽灵', '僵尸', '吸血鬼', '怪物', '变异', '末日', '丧尸', '屠杀', '虐待片', '刑讯', '折磨', '残忍', '残暴', '凶杀', '连环杀手', '变态杀手', '心理惊悚', '倫理片', '三級片', '色情片', '情色', '成人片', '禁片', '禁忌', '禁慾', '艷情', '艷史', '艷舞', '裸體', '裸露', '裸戲', '床戲', '激吻', '親熱', '親密', '纏綿', '纏身', '肉慾', '慾火', '慾念', '慾望', '情慾', '性感', '性騷擾', '性侵', '性虐', '性奴役', '虐殺片', '暴力片', '血腥片', '恐怖片', '驚悚', '驚悚片', '鬼片', '鬼魂', '厲鬼', '幽靈', '僵屍', '吸血鬼', '怪物', '變異', '末日', '喪屍', '屠殺', '虐待片', '刑訊', '折磨', '殘忍', '殘暴', '兇殺', '連環殺手', '變態殺手', '心理驚悚',
